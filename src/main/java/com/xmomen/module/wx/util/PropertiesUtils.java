 ...
 * @Package com.udf.wechat.util 
 * @Description: TODO() 
 * @author jizong.li 85150225@qq.com   
 * @date 2014年10月11日 下午4:05:10 
 * @version V1.0   
 */
public class PropertiesUtils {
	...
	public static Properties getProperties(){
		Properties prop = new Properties();
		String savePath = PropertiesUtils.class.getResource("/properties/config.properties").getPath();
		//以下方法读取属性文件会缓存问题
//		InputStream in = PropertiesUtils.class
//				.getResourceAsStream("/config.properties");
	...
	public static void modifyProperties(String key, String value) {
		try {
			...
			String path = PropertiesUtils.class.getResource("/properties/config.properties").getPath();
