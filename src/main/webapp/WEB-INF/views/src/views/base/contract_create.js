 ...
 */
define(function () {
    return ["$scope","ItemAPI", "CompanyAPI", "ItemCategoryAPI","$modal", "$ugDialog", "$state", "ContractAPI", "$modalMemberAdd", "$rootScope",
        function($scope, ItemAPI, CompanyAPI,ItemCategoryAPI, $modal, $ugDialog, $state, ContractAPI, $modalMemberAdd, $rootScope){
            $scope.init = function(){
